	...
	<div class="container">
		<div class="row">
			...
			<div class="alert alert-success">
				...
				echo "TOTAL NUMBER OF UNIQUE VISITORS/USERS:".$unique_visitors;
...
//mysql select query
		...
		<br>
		<div align="right"><button onclick="window.location.href='../blogadmin/index.php'" class="btn btn-primary"><i class='fa fa-chevron-up'></i> << Go Back</button></div>
		<br>
	</div>
</body>
</html>