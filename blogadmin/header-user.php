...
<html lang="en">
  <head>
    ...
    <title><?php echo ucwords('SKOOLEO ADMIN'); ?> | <?php echo (isset($x->TableTitle) ? $x->TableTitle : ''); ?></title>
    <!-- Bootstrap core CSS -->
  ...
  <!-- Sidebar -->
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">SKOOLEO ADMIN</a>
        </div>
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
         ...
         <ul class="nav navbar-nav navbar-right navbar-user">
            ...
            <ul class="dropdown-menu">
			  ...
			  HELLO GBENGA, MAKE SURE YOU UNCOMMENT BELOW <li> LATER TO GET ACCESS TO ADMIN AREA
			  -->
              <!--<li>
