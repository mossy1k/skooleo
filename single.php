...
$roo=mysqli_fetch_array($feedback);?>
<!DOCTYPE html>
<html lang="zxx">
<head>
				...
				<div class="col-lg-8 left-blog-info-w3layouts-agileits text-left">
					<div class="blog-grid-top">
						<div class="b-grid-top">
							<div class="blog_info_left_grid" align="center">
								<a href="#">
									<img src="blogadmin/images/<?php echo $row['photo']; ?>" class="img-fluid" alt="image not available" style="width:100%;height:auto">
								</a>
							</div>
									...
									<li>
										...
										<li class="mx-2">
											...
											<li>
												...
												<span class="myFavColor">Page Views/Hits: <a href="#">
														<i class="far fa-eye fa-x2"></i> <?php echo $roo['count']; ?>
													</a>
												</span>	
											</div>
										</div>
